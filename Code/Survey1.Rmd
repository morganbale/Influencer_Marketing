...
# Read in Data
Data is from our first survey using Qualtrics
```{r, include=FALSE}
...
# Fix Column Names
Renamed the columns so they are shorter and got rid of unecessary columns. 
```{r, include=FALSE}
# get rid of columns
survey_data <- survey_data %>%
  select(-c(X..ImportId...startDate...timeZone...America.Denver..,
            ...
            X..ImportId...distributionChannel..,  
            X..ImportId...userLanguage..,  
...
95.3% of respondents use social media. The median amount of time the survey took was 219.5 seconds (\~ 3 minutes and 40 seconds). 315 respondents passed the attention checks (87%).
